...
//CommandLineRunner puxa um método para execução automática
	...
	public void run(String... args) throws Exception {
		...
		/* Instanciando objetos do tipo Order com datas instanciadas usando o instant.parse
		 * ISO8601 = Data formatada em Greenwich (UTC - GMT). É o padrão de desenvolvimento
		 * u1, uN... no final da instanciação é uma forma de associação de objetos*/
